...
export const ALBUM_PLAYLIST_DATA = [
    {
        type: "Playlist",
        name: "Liked Songs",
        owner: "JeanPierreVeliz",
        numCanciones: 975,
    ...
    {
        type: "Playlist",
        name: "Comfort Y Musica Para Volar",
        owner: "JeanPierreVeliz",
        numCanciones: 975,
        img: "https://i2o.scdn.co/image/ab67706c0000cfa3c26863d50ccc53f2cdd86d9f"
    },
    {
        type: "Album",
        name: "Liked Songs",
    ...
    {
        type: "Playlist",
        name: "the way forward is not the way home",
        owner: "Darwinveliz116",
        numCanciones: 975,
